...
<!-- <button type="modal-header" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalCenter">
 	About Us
</button> -->
...
<!-- Button trigger modal -->
<button type="button" class="btn btn-large btn-block btn-success" data-toggle="modal" data-target="#exampleModalCenter"> Send Measurements </button>
